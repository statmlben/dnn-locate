...
class LocalGAN():
	def __init__(self, img_shape, labels, lam=0.01, method='mask', optimizer=Adam(0.0001)):
	...
	def build_detector(self):
		...
		# model.add(Dense(32 * 28 * 28, activation="relu"))
		# model.add(Reshape((28, 28, 32)))
		# # model.add(UpSampling2D())
		# model.add(Conv2D(32, kernel_size=4, padding="same"))
		# model.add(Activation("relu"))
		# # model.add(UpSampling2D())
		# model.add(Conv2D(16, kernel_size=4, padding="same", activation='relu'))
		# model.add(Conv2D(1, kernel_size=4, 
		# 				padding="same", 
		# 				activation='sigmoid', 
		...
		if self.method == 'mask':
			...
			# model.add(Dense(np.prod(self.img_shape), activation ='tanh', kernel_initializer='zeros',
			# 	bias_initializer='zeros', activity_regularizer=entropy_reg(self.lam)))
